              ...
              {conversation.length <= 2 && (
                <div className="quick-questions">
                  ...
                  <div className="quick-buttons">
                    <button 
                      onClick={() => handleQuickQuestion('Como funciona esse sistema?')}
                      disabled={isProcessing}
                    >
                      🤔 Sobre o sistema
                    </button>
                    <button 
                      onClick={() => handleQuickQuestion('O que você pode fazer?')}
                      disabled={isProcessing}
                    >
                      💡 Suas funções
                    </button>
                    <button 
                      onClick={() => handleQuickQuestion('Fale sobre tecnologia')}
                      disabled={isProcessing}
                    >
                      🚀 Tecnologia
                    </button>
