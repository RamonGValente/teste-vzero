...
import LiveKitCallButtons from '@/components/livekit/LiveKitCallButtons';
  ...
  return (
    <div className="flex-1 flex flex-col bg-background h-full overflow-hidden">
      ...
      <div className="flex items-center gap-3 p-4 border-b border-border bg-card flex-shrink-0 z-10">
        ...
        <div className="flex items-center gap-2">
          <ContactRanking />
          <LiveKitCallButtons currentUserId={currentUser?.id} contactId={contact?.id} currentUserName={currentUser?.full_name || 'UDG'} />
          <DropdownMenu>
